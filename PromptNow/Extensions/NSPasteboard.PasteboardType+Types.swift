...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/p0deje/PromptNow/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from PromptNow.
  static let fromPromptNow = NSPasteboard.PasteboardType(rawValue: "com.tomcandev.promptnow")
